...
module.exports.SignUP=(req,res)=>{
    ...
    async function createUser(hash){
        ...
        try{
            ...
            .execute("SELECT USERNAME FROM DOCTOR WHERE USERNAME = (:1)",[username]);
            ...
            await connection
            .execute("INSERT INTO DOCTOR (USERNAME,PASS) VALUES (:1,:2)",[username,hash]);
...
module.exports.ChangePassword = (req,res)=>{
    ...
    async function changePass(newHashPassword){
        ...
        try{
            ...
            if(bool){
                await connection
                .execute("UPDATE DOCTOR SET pass = (:1) WHERE username=(:2)",[newHashPassword,username]);
                await connection.commit();
                res.status(201);
